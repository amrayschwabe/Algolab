...
void testcases() {
    ...
    int vertices, edges, stores;
    cin >> vertices >> edges >> stores;
    //cout << "vertices " << vertices << " edges " << edges << " stores " << stores << endl;
    Graph G(vertices);
    ...
    eaG.addEdge(src, 0, INT_MAX);

    int tmp;
    for(int i =0; i<stores; ++i){
        cin >> tmp;
        eaG.addEdge(tmp, sink, 1);
